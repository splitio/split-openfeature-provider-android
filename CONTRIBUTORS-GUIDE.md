...
Split OpenFeature Provider is an open source project and we welcome feedback and contribution. The information below describes how to build the project with your changes, run the tests, and send the Pull Request(PR).
...
To run tests, select the provider module Android Studio project, click with two fingers and choose Run all option.
